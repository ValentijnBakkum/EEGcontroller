...
################################################################################
## Form generated from reading UI file 'interfaceQHJYSE.ui'
##
...
"}")
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/Qss/icons/target.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"border:none;")
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_9.sizePolicy().hasHeightForWidth())
        self.graphicsView_9.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_10.sizePolicy().hasHeightForWidth())
        self.graphicsView_10.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_11.sizePolicy().hasHeightForWidth())
        self.graphicsView_11.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_12.sizePolicy().hasHeightForWidth())
        self.graphicsView_12.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_13.sizePolicy().hasHeightForWidth())
        self.graphicsView_13.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_14.sizePolicy().hasHeightForWidth())
        self.graphicsView_14.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_15.sizePolicy().hasHeightForWidth())
        self.graphicsView_15.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_16.sizePolicy().hasHeightForWidth())
        self.graphicsView_16.setSizePolicy(sizePolicy10)
...
"color: rgb(12, 35, 64);")
        ...
        sizePolicy7.setHeightForWidth(self.frame_35.sizePolicy().hasHeightForWidth())
        self.frame_35.setSizePolicy(sizePolicy7)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_2.sizePolicy().hasHeightForWidth())
        self.graphicsView_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_3.sizePolicy().hasHeightForWidth())
        self.graphicsView_3.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_4.sizePolicy().hasHeightForWidth())
        self.graphicsView_4.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_5.sizePolicy().hasHeightForWidth())
        self.graphicsView_5.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_6.sizePolicy().hasHeightForWidth())
        self.graphicsView_6.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_7.sizePolicy().hasHeightForWidth())
        self.graphicsView_7.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.graphicsView_8.sizePolicy().hasHeightForWidth())
        self.graphicsView_8.setSizePolicy(sizePolicy10)
        ...
        self.startTrainBtn.setStyleSheet(u"color: rgb(255, 255, 255);")
...
"color: rgb(255, 255, 255);")
        ...
        sizePolicy8.setHeightForWidth(self.frame_10.sizePolicy().hasHeightForWidth())
        self.frame_10.setSizePolicy(sizePolicy8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_32.setText(QCoreApplication.translate("MainWindow", u"Margin", None))
        ...
        self.startTrainBtn.setText(QCoreApplication.translate("MainWindow", u"Start data collection!", None))
