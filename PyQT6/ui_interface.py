...
"}")
        ...
        self.buttonsBox.setMinimumSize(QSize(0, 0))
...
"border-radius: 10px;")
        ...
        sizePolicy10.setHeightForWidth(self.directionFrame.sizePolicy().hasHeightForWidth())
        self.directionFrame.setSizePolicy(sizePolicy10)
...
"border-radius: 10px")
        ...
        sizePolicy11.setHeightForWidth(self.directionLine.sizePolicy().hasHeightForWidth())
        self.directionLine.setSizePolicy(sizePolicy11)
        font5 = QFont()
        ...
        sizePolicy12.setHeightForWidth(self.valuesFrame.sizePolicy().hasHeightForWidth())
        self.valuesFrame.setSizePolicy(sizePolicy12)
...
"border-radius: 10px;")
        ...
        sizePolicy14.setVerticalStretch(60)
        sizePolicy14.setHeightForWidth(self.channelsFrame.sizePolicy().hasHeightForWidth())
        self.channelsFrame.setSizePolicy(sizePolicy14)
        ...
        sizePolicy15.setHeightForWidth(self.infoWidgetContainer.sizePolicy().hasHeightForWidth())
        self.infoWidgetContainer.setSizePolicy(sizePolicy15)
...
"color: rgb(255, 255, 255);")
        ...
        sizePolicy17.setVerticalStretch(90)
        sizePolicy17.setHeightForWidth(self.usersList.sizePolicy().hasHeightForWidth())
        self.usersList.setSizePolicy(sizePolicy17)
        font10 = QFont()
